package com.example.lyabaauctionapp.di
...
import com.example.lyabaauctionapp.data.remote.AuthInterceptor
...
object AppModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): AppDatabase =
        Room.databaseBuilder(context, AppDatabase::class.java, "lyaba.db")
